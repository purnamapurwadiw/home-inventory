...
from home_inventory.cli import demo_state
from home_inventory.storage import load_state, save_state
from home_inventory.models import generate_short_id
from home_inventory.validation import normalize_tags, require_text, validate_task_status
from home_inventory.services import (
    create_note,
    list_notes,
    get_note,
    update_note,
